...
class WeightControlViewModel(private val repo:DataRepository): ViewModel() {
    ...
    val allDataElement: LiveData<List<DataElementEntity>> = repo.allDataElement.asLiveData()

    //Получить один элемент
    fun getElement(elementId: Int): DataElementEntity = repo.getElement(elementId)
